...
func (*LoginResponse_Data) Descriptor() ([]byte, []int) {
	return file_proto_auth_auth_proto_rawDescGZIP(), []int{1, 0}
}
...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\x06Logout\x12\x13.auth.LogoutRequest\x1a\x15.auth.GenericResponseB!Z\x1fuser-management/proto/auth;authb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	3, // 4: auth.AuthService.Logout:output_type -> auth.GenericResponse
